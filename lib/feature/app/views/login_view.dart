                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        Obx(
                          () => TextFormFieldWidget(
                            labelText: controller.isLabelPass.value
                                ? S.current.password
                                : null,
                            ...
                            onChanged: (String? value) {
                              if (value != null && value.isNotEmpty) {
                                controller.isLabelPass.value = true;
                              } else {
                                controller.isLabelPass.value = false;
                              }
                            },
                        ...
                        Obx(
                          () => RoundedButtonWidget(
                            onPressed: controller.isActiveButton.value
                                ? () async => await controller.onLogin()
                                : null,
